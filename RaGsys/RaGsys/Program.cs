            ...
            /*case "1.0":
{
        ...
        case "2":
            var ka = new FSAutomate(new List<Symbol>() { "S0","A","B","C","D","E","F","G","H","I","J","K","L","qf" },
          ...
          */
          case "4.1":
            /*var regGr = new Grammar(new List<Symbol>() {  "a", "b","c", "d", "f", "z", "r", "t", "g", ""},
                                    new List<Symbol>() { "S","A","B","C", "D", "R", "T", "H", "G", "V", },
                                    "S");

            regGr.AddRule("A",new List<Symbol>() { "bC" });
            regGr.AddRule("B",new List<Symbol>() { "cA" });
            regGr.AddRule("C",new List<Symbol>() { "dB" });
            regGr.AddRule("D",new List<Symbol>() { "R" });
            regGr.AddRule("R",new List<Symbol>() { "f" });
            regGr.AddRule("S",new List<Symbol>() { "aABT" });
            regGr.AddRule("T",new List<Symbol>() { "" });
            regGr.AddRule("H",new List<Symbol>() { "z" });
            regGr.AddRule("G",new List<Symbol>() { "r" });
            regGr.AddRule("S",new List<Symbol>() { "gV" });
            regGr.AddRule("V",new List<Symbol>() { "Vt" });
          ...
          case "6.2": {  // Algorithms приведенная грамматика G            
           ...
           case "7.0": { 
            var CFGrammar = new Grammar(new List<Symbol>() { "a", "b", "c", "d", "f", "t", "g" },
                            new List<Symbol>() { "S", "A", "B", "C", "D", "R", "V", "V'" },
                                                 "S");
            
            CFGrammar.AddRule("A", new List<Symbol>() { "b", "C" });
            CFGrammar.AddRule("B", new List<Symbol>() { "c", "A" });
            CFGrammar.AddRule("C", new List<Symbol>() { "d", "D" });
            CFGrammar.AddRule("D", new List<Symbol>() { "f" });
            CFGrammar.AddRule("R", new List<Symbol>() { "f" });
            CFGrammar.AddRule("S", new List<Symbol>() { "a", "A", "B" });
            CFGrammar.AddRule("S", new List<Symbol>() { "g", "V" });
            CFGrammar.AddRule("V", new List<Symbol>() { "t" });
            CFGrammar.AddRule("V", new List<Symbol>() { "t", "V'" });
            CFGrammar.AddRule("V'", new List<Symbol>() { "t" });
            CFGrammar.AddRule("V'", new List<Symbol>() { "t", "V'" });
          ...
          /*
            ...
            var LROGrammar = new SLRGrammar(new List<Symbol>() { "a", "b", "c", "d", "f", "t", "g", " " },
                                 new List<Symbol>() { "S", "A", "B", "C", "D", "R", "V", "V'", "T" },
                                 new List<Production>(),
                                 "S");

            LROGrammar.AddRule("A", new List<Symbol>() { "b", "C" });
            LROGrammar.AddRule("B", new List<Symbol>() { "c", "A" });
            LROGrammar.AddRule("C", new List<Symbol>() { "d", "D" });
            LROGrammar.AddRule("D", new List<Symbol>() { "f" });
            LROGrammar.AddRule("R", new List<Symbol>() { "f" });
            LROGrammar.AddRule("S", new List<Symbol>() { "a", "A", "B" });
            LROGrammar.AddRule("S", new List<Symbol>() { "g", "V" });
            LROGrammar.AddRule("V", new List<Symbol>() { "t", "T" });
            LROGrammar.AddRule("V'", new List<Symbol>() { "t", "T" });
            LROGrammar.AddRule("T", new List<Symbol>() { "V'" });
            LROGrammar.AddRule("T", new List<Symbol>() { " " });


            LROGrammar.Construct();
            LROGrammar.Inference();
            break;
          case "16.1": {
